...
import { grantReferralPurchaseCommissions as grantCleanReferralPurchaseCommissions } from "./referralCommissions.js";
...
async function applyPaidInvoice(deps, invoice, payment) {
  ...
  await grantCleanReferralPurchaseCommissions(deps, invoice);
  await deps.db.collection("stars_invoices").updateOne(
