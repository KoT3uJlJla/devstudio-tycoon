...
const referralHelpers = [
  ...
  "  if (!match) return \"\";",
  "  try { const mixed = referralBase36ToBigInt(match[1]); if (mixed === null) return \"\"; const decoded = mixed ^ REFERRAL_CODE_MASK; return decoded > 0n ? decoded.toString(10) : \"\"; } catch { return \"\"; }",
  "}",
