...
export const genres: Genre[] = [
  { id: 'arcade', name: 'Аркада', nameEn: 'Arcade', emoji: '🕹️', isBase: true, difficulty: 0.85, ideal: { pre: [35, 50, 15], production: [15, 55, 30], post: [20, 45, 35] } },
  { id: 'platformer', name: 'Платформер', nameEn: 'Platformer', emoji: '🍄', isBase: true, difficulty: 0.95, ideal: { pre: [30, 55, 15], production: [10, 65, 25], post: [20, 55, 25] } },
  { id: 'rpg', name: 'РПГ', nameEn: 'RPG', emoji: '⚔️', isBase: true, difficulty: 1.28, ideal: { pre: [20, 30, 50], production: [45, 30, 25], post: [50, 25, 25] } },
  { id: 'strategy', name: 'Стратегия', nameEn: 'Strategy', emoji: '♟️', isBase: true, difficulty: 1.18, ideal: { pre: [40, 40, 20], production: [20, 35, 45], post: [25, 35, 40] } },
  { id: 'puzzle', name: 'Головоломка', nameEn: 'Puzzle', emoji: '🧩', isBase: true, difficulty: 0.88, ideal: { pre: [25, 60, 15], production: [15, 65, 20], post: [15, 50, 35] } },
  { id: 'horror', name: 'Хоррор', nameEn: 'Horror', emoji: '👻', difficulty: 1.05, ideal: { pre: [25, 25, 50], production: [35, 35, 30], post: [45, 25, 30] } },
  { id: 'racing', name: 'Гонки', nameEn: 'Racing', emoji: '🏎️', difficulty: 1.03, ideal: { pre: [45, 45, 10], production: [10, 60, 30], post: [15, 45, 40] } },
  { id: 'fighting', name: 'Файтинг', nameEn: 'Fighting', emoji: '🥊', difficulty: 1.07, ideal: { pre: [30, 55, 15], production: [10, 65, 25], post: [20, 45, 35] } },
  { id: 'simulator', name: 'Симулятор', nameEn: 'Simulator', emoji: '🧪', difficulty: 1.15, ideal: { pre: [45, 35, 20], production: [20, 35, 45], post: [35, 35, 30] } },
  { id: 'visual-novel', name: 'Визуальная новелла', nameEn: 'Visual Novel', emoji: '💬', difficulty: 0.92, ideal: { pre: [15, 25, 60], production: [60, 25, 15], post: [35, 25, 40] } },
  { id: 'roguelike', name: 'Рогалик', nameEn: 'Roguelike', emoji: '🎲', difficulty: 1.22, ideal: { pre: [35, 45, 20], production: [20, 50, 30], post: [30, 45, 25] } },
  { id: 'deckbuilder', name: 'Колодострой', nameEn: 'Deckbuilder', emoji: '🃏', difficulty: 1.1, ideal: { pre: [30, 50, 20], production: [25, 50, 25], post: [20, 55, 25] } },
  { id: 'survival', name: 'Survival', nameEn: 'Survival', emoji: '🏕️', difficulty: 1.24, ideal: { pre: [35, 35, 30], production: [25, 45, 30], post: [45, 30, 25] } },
  { id: 'metroidvania', name: 'Метроидвания', nameEn: 'Metroidvania', emoji: '🗺️', difficulty: 1.18, ideal: { pre: [35, 45, 20], production: [15, 60, 25], post: [35, 45, 20] } },
  { id: 'sandbox', name: 'Песочница', nameEn: 'Sandbox', emoji: '🏗️', difficulty: 1.35, ideal: { pre: [45, 35, 20], production: [15, 45, 40], post: [50, 30, 20] } },
  { id: 'battle-royale', name: 'Королевская битва', nameEn: 'Battle Royale', emoji: '🪂', difficulty: 1.45, ideal: { pre: [45, 40, 15], production: [10, 45, 45], post: [25, 45, 30] } },
  { id: 'rhythm', name: 'Ритм-игра', nameEn: 'Rhythm Game', emoji: '🎧', difficulty: 1.02, ideal: { pre: [25, 45, 30], production: [15, 55, 30], post: [15, 35, 50] } },
  { id: 'party', name: 'Вечериночная игра', nameEn: 'Party Game', emoji: '🎉', difficulty: 0.9, ideal: { pre: [25, 60, 15], production: [15, 55, 30], post: [25, 45, 30] } },
  { id: 'idle', name: 'Айдл', nameEn: 'Idle', emoji: '⏳', difficulty: 0.86, ideal: { pre: [35, 45, 20], production: [20, 45, 35], post: [20, 55, 25] } },
  { id: 'tower-defense', name: 'Защита башни', nameEn: 'Tower Defense', emoji: '🏰', difficulty: 1.05, ideal: { pre: [35, 45, 20], production: [15, 45, 40], post: [25, 45, 30] } },
  { id: 'moba-lite', name: 'MOBA-lite', nameEn: 'MOBA-lite', emoji: '🛡️', difficulty: 1.4, ideal: { pre: [40, 40, 20], production: [15, 40, 45], post: [30, 45, 25] } },
  { id: 'city-builder', name: 'Градостроитель', nameEn: 'City Builder', emoji: '🏙️', difficulty: 1.3, ideal: { pre: [45, 35, 20], production: [20, 35, 45], post: [45, 35, 20] } },
  { id: 'detective-game', name: 'Детективная', nameEn: 'Detective', emoji: '🔎', difficulty: 1.0, ideal: { pre: [20, 35, 45], production: [45, 35, 20], post: [40, 30, 30] } },
  { id: 'sports-manager', name: 'Спорт-менеджер', nameEn: 'Sports Manager', emoji: '📋', difficulty: 1.17, ideal: { pre: [40, 35, 25], production: [25, 35, 40], post: [35, 35, 30] } },
  { id: 'social-sim', name: 'Соц-сим', nameEn: 'Social Sim', emoji: '💞', difficulty: 1.08, ideal: { pre: [20, 35, 45], production: [50, 30, 20], post: [40, 35, 25] } },
];

export const themes: Theme[] = [
  { id: 'space', name: 'Космос', nameEn: 'Space', emoji: '🚀', isBase: true, focusBias: { pre: [6, 0, -6], production: [-4, 0, 4], post: [2, 4, -6] } },
  { id: 'fantasy', name: 'Фэнтези', nameEn: 'Fantasy', emoji: '🐉', isBase: true, focusBias: { pre: [-4, -2, 6], production: [4, 2, -6], post: [8, -4, -4] } },
  { id: 'cyberpunk', name: 'Киберпанк', nameEn: 'Cyberpunk', emoji: '🌆', isBase: true, focusBias: { pre: [6, 2, -8], production: [-4, 0, 4], post: [0, 10, -10] } },
  { id: 'school', name: 'Школа', nameEn: 'School', emoji: '🎒', isBase: true, focusBias: { pre: [-8, 2, 6], production: [8, 2, -10], post: [2, 0, -2] } },
  { id: 'zombie', name: 'Зомби', nameEn: 'Zombies', emoji: '🧟', isBase: true, focusBias: { pre: [0, -4, 4], production: [-2, 2, 0], post: [8, -4, -4] } },
  { id: 'detective', name: 'Детектив', nameEn: 'Detective', emoji: '🕵️', focusBias: { pre: [-6, 2, 4], production: [8, -2, -6], post: [6, -2, -4] } },
  { id: 'medieval', name: 'Средневековье', nameEn: 'Medieval', emoji: '🏰', focusBias: { pre: [-2, 0, 2], production: [4, 0, -4], post: [8, -4, -4] } },
  { id: 'sport', name: 'Спорт', nameEn: 'Sports', emoji: '🏀', focusBias: { pre: [2, 8, -10], production: [-8, 8, 0], post: [-2, 2, 0] } },
  { id: 'postapoc', name: 'Постапокалипсис', nameEn: 'Post-Apocalypse', emoji: '☢️', focusBias: { pre: [2, -2, 0], production: [-2, 4, -2], post: [10, -5, -5] } },
  { id: 'military', name: 'Военный', nameEn: 'Military', emoji: '🎖️', focusBias: { pre: [4, 4, -8], production: [-10, 2, 8], post: [0, 4, -4] } },
  { id: 'mythology', name: 'Мифология', nameEn: 'Mythology', emoji: '🏺', focusBias: { pre: [-6, 0, 6], production: [6, 0, -6], post: [8, -2, -6] } },
  { id: 'underwater', name: 'Подводный мир', nameEn: 'Underwater World', emoji: '🐙', focusBias: { pre: [4, 0, -4], production: [-2, 2, 0], post: [8, 6, -14] } },
  { id: 'pirates', name: 'Пираты', nameEn: 'Pirates', emoji: '🏴‍☠️', focusBias: { pre: [-2, 4, -2], production: [4, 2, -6], post: [8, -2, -6] } },
  { id: 'kaiju', name: 'Кайдзю', nameEn: 'Kaiju', emoji: '🦖', focusBias: { pre: [4, 4, -8], production: [-6, 6, 0], post: [0, 10, -10] } },
  { id: 'dreams', name: 'Сны', nameEn: 'Dreams', emoji: '🌙', focusBias: { pre: [-4, 0, 4], production: [4, -2, -2], post: [10, -2, -8] } },
  { id: 'office', name: 'Офис', nameEn: 'Office', emoji: '💼', focusBias: { pre: [-4, 4, 0], production: [6, -2, -4], post: [0, 0, 0] } },
  { id: 'food', name: 'Еда', nameEn: 'Food', emoji: '🍜', focusBias: { pre: [-2, 8, -6], production: [2, 8, -10], post: [0, 2, -2] } },
  { id: 'music', name: 'Музыка', nameEn: 'Music', emoji: '🎸', focusBias: { pre: [-2, 4, -2], production: [4, 4, -8], post: [-8, 2, 6] } },
  { id: 'ai-revolt', name: 'ИИ-бунт', nameEn: 'AI Revolt', emoji: '🤖', focusBias: { pre: [8, 0, -8], production: [-6, 0, 6], post: [0, 8, -8] } },
  { id: 'time-travel', name: 'Петля времени', nameEn: 'Time Loop', emoji: '⌛', focusBias: { pre: [4, 0, -4], production: [2, 2, -4], post: [6, -2, -4] } },
];
...
export const platforms: Platform[] = [
  { id: 'micro_pc', name: 'Микро-ПК', nameEn: 'Micro-PC', emoji: '💾', userbase: 1, techComplexity: 1, unlockLevel: 1 },
  { id: 'pocket_play', name: 'PocketPlay', nameEn: 'PocketPlay', emoji: '📱', userbase: 1.25, techComplexity: 1.08, unlockLevel: 2 },
  { id: 'game_station', name: 'GameStation', nameEn: 'GameStation', emoji: '🎮', userbase: 1.45, techComplexity: 1.22, unlockLevel: 4 },
  { id: 'smart_game', name: 'SmartGame', nameEn: 'SmartGame', emoji: '📺', userbase: 1.62, techComplexity: 1.35, unlockLevel: 7 },
];
...
export const employeePool: Employee[] = [
  { id: 'dev-lena', role: 'Программист', roleEn: 'Programmer', name: 'Лена Байт', level: 1, cost: 3000, speedBoost: 0.12, incomeBoost: 0.03, scienceBoost: 0.02, scoreBoost: 0.00, specialization: '+ движок', specializationEn: '+ engine' },
  { id: 'art-kai', role: 'Художник', roleEn: 'Artist', name: 'Кай Неон', level: 1, cost: 3300, speedBoost: 0.08, incomeBoost: 0.08, scienceBoost: 0.00, scoreBoost: 0.03, specialization: '+ графика', specializationEn: '+ visuals' },
  { id: 'design-mira', role: 'Дизайнер', roleEn: 'Designer', name: 'Мира Петля', level: 1, cost: 3600, speedBoost: 0.10, incomeBoost: 0.05, scienceBoost: 0.01, scoreBoost: 0.04, specialization: '+ геймплей', specializationEn: '+ gameplay' },
  { id: 'marketing-tom', role: 'Маркетолог', roleEn: 'Marketer', name: 'Том Хайп', level: 1, cost: 4200, speedBoost: 0.04, incomeBoost: 0.16, scienceBoost: 0.00, scoreBoost: -0.02, specialization: '+ хайп, -полиш', specializationEn: '+ hype, -polish' },
  { id: 'producer-nika', role: 'Продюсер', roleEn: 'Producer', name: 'Ника Scope', level: 1, cost: 4600, speedBoost: 0.07, incomeBoost: 0.12, scienceBoost: 0.02, scoreBoost: 0.03, specialization: '- хаос сроков', specializationEn: '- deadline chaos' },
  { id: 'analyst-zen', role: 'Аналитик', roleEn: 'Analyst', name: 'Зен Метрика', level: 1, cost: 3900, speedBoost: 0.05, incomeBoost: 0.10, scienceBoost: 0.10, scoreBoost: 0.01, specialization: '+ аудитория', specializationEn: '+ audience' },
  { id: 'dev-oleg', role: 'Программист', roleEn: 'Programmer', name: 'Олег Шейдер', level: 2, cost: 7400, speedBoost: 0.18, incomeBoost: 0.00, scienceBoost: 0.04, scoreBoost: 0.04, specialization: '+ стабильный билд', specializationEn: '+ stable build' },
  { id: 'qa-ira', role: 'Аналитик', roleEn: 'Analyst', name: 'Ира Чеклист', level: 2, cost: 8200, speedBoost: -0.04, incomeBoost: 0.03, scienceBoost: 0.08, scoreBoost: 0.12, specialization: '+ качество, -скорость', specializationEn: '+ quality, -speed' },
  { id: 'mark-roma', role: 'Маркетолог', roleEn: 'Marketer', name: 'Рома Вирус', level: 2, cost: 9100, speedBoost: -0.06, incomeBoost: 0.30, scienceBoost: 0.00, scoreBoost: -0.04, specialization: '+ продажи, -темп', specializationEn: '+ sales, -pace' },
  { id: 'prod-sasha', role: 'Продюсер', roleEn: 'Producer', name: 'Саша Роадмап', level: 2, cost: 9800, speedBoost: 0.14, incomeBoost: 0.10, scienceBoost: 0.03, scoreBoost: 0.05, specialization: '+ дедлайны', specializationEn: '+ deadlines' },
  { id: 'artist-ava', role: 'Художник', roleEn: 'Artist', name: 'Ава Панель', level: 2, cost: 8700, speedBoost: 0.02, incomeBoost: 0.12, scienceBoost: 0.00, scoreBoost: 0.10, specialization: '+ стиль', specializationEn: '+ style' },
  { id: 'designer-lev', role: 'Дизайнер', roleEn: 'Designer', name: 'Лев Баланс', level: 2, cost: 9300, speedBoost: 0.08, incomeBoost: 0.04, scienceBoost: 0.05, scoreBoost: 0.11, specialization: '+ баланс', specializationEn: '+ balance' },
  { id: 'dev-maya', role: 'Программист', roleEn: 'Programmer', name: 'Майя Сборка', level: 3, cost: 15800, speedBoost: 0.26, incomeBoost: 0.02, scienceBoost: 0.08, scoreBoost: 0.08, specialization: '+ техдолг', specializationEn: '+ tech debt' },
  { id: 'monet-gleb', role: 'Маркетолог', roleEn: 'Marketer', name: 'Глеб ARPU', level: 3, cost: 17200, speedBoost: -0.10, incomeBoost: 0.48, scienceBoost: 0.02, scoreBoost: -0.08, specialization: '+ монетизация, -оценка', specializationEn: '+ monetization, -score' },
  { id: 'ux-nora', role: 'Дизайнер', roleEn: 'Designer', name: 'Нора UX', level: 3, cost: 18100, speedBoost: 0.04, incomeBoost: 0.12, scienceBoost: 0.08, scoreBoost: 0.18, specialization: '+ удержание', specializationEn: '+ retention' },
  { id: 'sci-yun', role: 'Аналитик', roleEn: 'Analyst', name: 'Юн Данные', level: 3, cost: 15100, speedBoost: -0.02, incomeBoost: 0.06, scienceBoost: 0.28, scoreBoost: 0.05, specialization: '+ очки науки', specializationEn: '+ science points' },
  { id: 'prod-kira', role: 'Продюсер', roleEn: 'Producer', name: 'Кира Релиз', level: 3, cost: 19600, speedBoost: 0.16, incomeBoost: 0.18, scienceBoost: 0.07, scoreBoost: 0.12, specialization: '+ релизный ритм', specializationEn: '+ release rhythm' },
  { id: 'sound-vik', role: 'Художник', roleEn: 'Artist', name: 'Вик Саунд', level: 3, cost: 16300, speedBoost: 0.00, incomeBoost: 0.10, scienceBoost: 0.04, scoreBoost: 0.14, specialization: '+ звук и вайб', specializationEn: '+ sound and vibe' },
  { id: 'lead-anna', role: 'Программист', roleEn: 'Programmer', name: 'Анна Архитектор', level: 4, cost: 36000, speedBoost: 0.34, incomeBoost: 0.08, scienceBoost: 0.12, scoreBoost: 0.14, specialization: '+ большие проекты', specializationEn: '+ big projects' },
  { id: 'creative-pasha', role: 'Дизайнер', roleEn: 'Designer', name: 'Паша Директор', level: 4, cost: 42000, speedBoost: -0.05, incomeBoost: 0.14, scienceBoost: 0.10, scoreBoost: 0.32, specialization: '+ сильная оценка, -темп', specializationEn: '+ strong score, -pace' },
  { id: 'biz-alisa', role: 'Маркетолог', roleEn: 'Marketer', name: 'Алиса Паблишер', level: 4, cost: 39000, speedBoost: -0.08, incomeBoost: 0.62, scienceBoost: 0.05, scoreBoost: 0.02, specialization: '+ прибыль, -скорость', specializationEn: '+ profit, -speed' },
  { id: 'lab-dan', role: 'Аналитик', roleEn: 'Analyst', name: 'Дан Лаборатория', level: 4, cost: 33500, speedBoost: 0.03, incomeBoost: 0.08, scienceBoost: 0.42, scoreBoost: 0.10, specialization: '+ наука', specializationEn: '+ science' },
  { id: 'exec-mila', role: 'Продюсер', roleEn: 'Producer', name: 'Мила Executive', level: 4, cost: 47000, speedBoost: 0.22, incomeBoost: 0.28, scienceBoost: 0.12, scoreBoost: 0.20, specialization: '+ всё, дорого', specializationEn: '+ everything, expensive' },
  { id: 'ghost-den', role: 'Программист', roleEn: 'Programmer', name: 'Дэн Горящий', level: 2, cost: 6200, speedBoost: 0.30, incomeBoost: -0.04, scienceBoost: -0.02, scoreBoost: -0.10, specialization: '+ скорость, -качество', specializationEn: '+ speed, -quality' },
  { id: 'trend-lika', role: 'Маркетолог', roleEn: 'Marketer', name: 'Лика Тренд', level: 2, cost: 7800, speedBoost: -0.03, incomeBoost: 0.24, scienceBoost: 0.02, scoreBoost: 0.00, specialization: '+ тренды', specializationEn: '+ trends' },
  { id: 'mentor-boris', role: 'Продюсер', roleEn: 'Producer', name: 'Борис Ментор', level: 3, cost: 20500, speedBoost: 0.10, incomeBoost: 0.08, scienceBoost: 0.22, scoreBoost: 0.16, specialization: '+ рост команды', specializationEn: '+ team growth' },
];

export const researchNodes: ResearchNode[] = [
  { id: 'product-instinct', title: 'Продуктовое чутьё', titleEn: 'Product Instinct', description: 'На 7 дней показывает силу жанр × сеттинг и мягкие подсказки по фокусу разработки.', descriptionEn: 'For 7 days, shows genre x setting strength and gentle focus tips.', cost: 0, effect: '7 дней подсказок', effectEn: '7 days of hints' },
  { id: 'market-analysis', title: 'Маркетинговый анализ', titleEn: 'Market Read', description: 'Дешевле раскрывать настроение живой аудитории.', descriptionEn: 'Makes it cheaper to reveal what live players want.', cost: 22, effect: '-35% цена скана', effectEn: '-35% scan cost' },
  { id: 'fast-prototype', title: 'Быстрый прототип', titleEn: 'Fast Prototype', description: 'Команда быстрее доводит проект до играбельного прототипа.', descriptionEn: 'The team reaches a playable build faster.', cost: 24, effect: '+10% скорость', effectEn: '+10% speed' },
  { id: 'budget-ops', title: 'Бюджетный продакшен', titleEn: 'Lean Production', description: 'Сокращает стоимость разработки без потери качества.', descriptionEn: 'Cuts development cost without hurting quality.', cost: 30, effect: '-10% стоимость разработки', effectEn: '-10% dev cost' },
  { id: 'pixel-polish', title: 'Панельный полиш', titleEn: 'Storefront Polish', description: 'Игры лучше выглядят на карточках и в публикациях.', descriptionEn: 'Games look sharper on cards and shared posts.', cost: 32, effect: '+5% продажи', effectEn: '+5% sales' },
  { id: 'community-posts', title: 'Посты в комьюнити', titleEn: 'Community Posts', description: 'Мемы и девлоги повышают интерес.', descriptionEn: 'Memes and devlogs make players more curious.', cost: 36, effect: '+7% доход', effectEn: '+7% income' },
  { id: 'pocket-play-sdk', title: 'Набор PocketPlay', titleEn: 'PocketPlay Kit', description: 'Открывает мобильную платформу PocketPlay.', descriptionEn: 'Unlocks the PocketPlay mobile platform.', cost: 40, effect: 'Открывает платформу', effectEn: 'Unlocks a platform', requires: 'fast-prototype' },
  { id: 'qa-checklist', title: 'Чеклист тестирования', titleEn: 'QA Checklist', description: 'Меньше багов перед релизом.', descriptionEn: 'Fewer bugs before release.', cost: 42, effect: '+0.3 оценка', effectEn: '+0.3 score' },
  { id: 'game-feel', title: 'Ощущение от игры', titleEn: 'Game Feel', description: 'Тапы и анимации ощущаются сочнее.', descriptionEn: 'Taps and animations feel juicier.', cost: 48, effect: '+0.4 оценка', effectEn: '+0.4 score' },
  { id: 'micro-influencers', title: 'Микро-инфлюенсеры', titleEn: 'Micro-Influencers', description: 'Больше продаж на релизе.', descriptionEn: 'More sales when the game launches.', cost: 52, effect: '+10% продажи', effectEn: '+10% sales' },
  { id: 'junior-pipeline', title: 'Поток джунов', titleEn: 'Junior Pipeline', description: 'Найм становится дешевле.', descriptionEn: 'Hiring gets cheaper.', cost: 58, effect: '-10% цена найма', effectEn: '-10% hire cost' },
  { id: 'producer-calendar', title: 'Продюсерский календарь', titleEn: 'Producer Calendar', description: 'Снижает риск провалов популярности в первые дни.', descriptionEn: 'Lowers the risk of early popularity drops.', cost: 64, effect: 'стабильнее жизненный цикл', effectEn: 'steadier life cycle' },
  { id: 'service-model', title: 'Сервисная модель', titleEn: 'Live Service Lite', description: 'Игры дольше зарабатывают после релиза.', descriptionEn: 'Games keep earning longer after release.', cost: 72, effect: '+15% пассивный доход', effectEn: '+15% passive income' },
  { id: 'sound-lab', title: 'Звуковая лаборатория', titleEn: 'Sound Lab', description: 'Звук помогает отзывам.', descriptionEn: 'Sound design helps reviews land better.', cost: 78, effect: '+0.2 оценка', effectEn: '+0.2 score' },
  { id: 'liveops-lite', title: 'Поддержка релизов', titleEn: 'Release Support', description: 'Случайные события чаще повышают популярность, чем ломают её.', descriptionEn: 'Life-cycle events help popularity more often than they hurt it.', cost: 86, effect: '+события жизни игры', effectEn: '+game-life events' },
  { id: 'game-station-sdk', title: 'Набор GameStation', titleEn: 'GameStation Kit', description: 'Открывает консольную платформу.', descriptionEn: 'Unlocks the console platform.', cost: 96, effect: 'Платформа 3', effectEn: 'Platform 3', requires: 'pocket-play-sdk' },
  { id: 'viral-hooks', title: 'Вирусные крючки', titleEn: 'Viral Hooks', description: 'Хиты чаще получают органический всплеск.', descriptionEn: 'Hit games are more likely to catch organic buzz.', cost: 104, effect: '+15% доход хитов', effectEn: '+15% hit income' },
  { id: 'async-standups', title: 'Асинхронные стендапы', titleEn: 'Async Standups', description: 'Студия лучше работает офлайн.', descriptionEn: 'The studio earns better while you are away.', cost: 112, effect: '+20% офлайн-доход', effectEn: '+20% offline income' },
  { id: 'reusable-tech', title: 'Переиспользуемые технологии', titleEn: 'Reusable Tech', description: 'Сложные технологии дешевле повторно использовать.', descriptionEn: 'Complex tech is cheaper to reuse on later projects.', cost: 120, effect: '-8% стоимость разработки', effectEn: '-8% dev cost' },
  { id: 'engine-v2', title: 'Движок 2.0', titleEn: 'Engine 2.0', description: 'База для больших проектов.', descriptionEn: 'A stronger base for bigger games.', cost: 138, effect: '+15% скорость', effectEn: '+15% speed', requires: 'reusable-tech' },
  { id: 'ai-assist', title: 'ИИ-помощник', titleEn: 'AI Helper', description: 'Ускоряет рутину, но повышает технологическую сложность.', descriptionEn: 'Speeds up routine work, but adds tech complexity.', cost: 156, effect: '+12% скорость', effectEn: '+12% speed' },
  { id: 'team-synergy', title: 'Синергия команды', titleEn: 'Team Synergy', description: 'Каждый сотрудник чуть сильнее ускоряет разработку.', descriptionEn: 'Every employee gives a little more development speed.', cost: 168, effect: '+командный буст', effectEn: '+team boost' },
  { id: 'smart-game-sdk', title: 'Набор SmartGame', titleEn: 'SmartGame Kit', description: 'Открывает ТВ/облачную платформу.', descriptionEn: 'Unlocks the TV/cloud platform.', cost: 185, effect: 'Платформа 4', effectEn: 'Platform 4', requires: 'game-station-sdk' },
  { id: 'data-warehouse', title: 'Хранилище данных', titleEn: 'Data Warehouse', description: 'Живая аудитория обучается быстрее и точнее показывает спрос.', descriptionEn: 'The live audience model learns faster and reads demand more clearly.', cost: 205, effect: '+точность аудитории', effectEn: '+audience accuracy' },
  { id: 'seasonal-pr', title: 'Сезонный PR', titleEn: 'Seasonal PR', description: 'Недельный рейтинг получает дополнительный скоринг за свежие хиты.', descriptionEn: 'Fresh hits get an extra push in the weekly rating.', cost: 230, effect: '+рейтинг', effectEn: '+rating' },
];
