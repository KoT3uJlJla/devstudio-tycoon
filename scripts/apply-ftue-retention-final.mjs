...
function insertBefore(source, needle, addition, label) {
  ...
  if (index === -1) throw new Error(`ftue-retention-final: missing ${label}`);
...
patchFile('src/App.tsx', (source) => {
  ...
  if (!next.includes('FirstSessionContractBar') || !next.includes('DailyContractCard')) {
    throw new Error('ftue-retention-final: critical UI blocks were not inserted');
  }
  return next;
});
...
console.log('apply-ftue-retention-final: ok');
